...
class NoteListActivity : AppCompatActivity(), //NavigationView.OnNavigationItemSelectedListener,
    ...
    private val noteRecyclerAdapter by lazy {
        NoteRecyclerAdapter(this, viewModel.notesFromDatabase.value ?: listOf<NoteInfo>(), this)
    }
    ...
    /*private val itemTouchHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(
        ...
        override fun onMove(
            ...
            // val data = viewModel.notesFromDatabase.value?.toMutableList()!!
            //   Log.i(tag, "Data Before Swap $data")
            *//*    Collections.swap(
                    data,
                    startPosition,
                    toPosition
            ...
            // Log.i(tag, "Data After Swap In OnSwap ${data}")
        ...
        override fun clearView(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder) {
            ...
            // Log.i(tag, "Data After Swap ${viewModel.notesFromDatabase.value}")
...
*/
    ...
    private fun displayNotes() {
        ...
        viewModel.notesFromDatabase.observe(this, { notesFromDatabase ->
            Log.i(tag, "Note From Database After Swap $notesFromDatabase")
